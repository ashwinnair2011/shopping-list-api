...
namespace shopping_list_api.Migrations
{
    ...
    [Migration("20250309113056_AddDefaultSystemUser")]
    partial class AddDefaultSystemUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("shopping_list_api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2025, 3, 9, 11, 30, 56, 353, DateTimeKind.Utc).AddTicks(4353),
                            Permissions = "[\"ADMIN\"]",
                            UserName = "system.user",
                            UserPassword = "$2a$11$X/97WLnh.HPwpb3Imz1ZEuDJL7dPx3WqhAymGqutj.XSxaUWpzAum"
                        });
                });
